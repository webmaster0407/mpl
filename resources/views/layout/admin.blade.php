...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>@if(isset($page_title)){{ __($page_title) }} @else {{ __("Admin | Home") }} @endif </title>
		<meta name="csrf_token" content="{{ csrf_token() }}">
		<meta name="description" content="@if(isset($page_description)){{ $page_description }} @else {{ 'Admin home page' }} @endif" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			...
			<a href="{{route('admin.home')}}">
				<img alt="Logo" src="{{ asset('assets/admin/media/logos/logo-light.png')}}"  style="width: 55%;" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<!--begin::Topbar-->
							<div class="topbar">
								@include('partials.admin-language')
								<!--begin::User-->
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{ strtoupper(substr(session('admin')->name, 0, 1) ) }}</span>
										</span>
									</div>
								</div>
								<!--end::User-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">MPL</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark">
								<a href="#" target="_blank" class="nav-link pl-0 pr-5">{{ __('About')}}</a>
								<a href="#" target="_blank" class="nav-link pl-0 pr-0">{{ __('Contact')}}</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0">{{ __('My Profile')}}</h3>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{session('admin')->name}}</a>
						<div class="text-muted mt-1">{{ __('Administrator')}}</div>
						<div class="navi mt-2">
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{ session('admin')->email }}</span>
								</span>
							</a>
							<a href="{{ route('admin.logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">{{ __('Sign Out')}}</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="{{ route('admin.updateProfile') }}" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">{{ __('Update Profile')}}
					...
					<a href="{{ route('admin.changePassword') }}"  class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">{{ __('Change Password')}}
								<span class="label label-light-danger label-inline font-weight-bold">{{ __('update')}}</span></div>
							</div>
						</div>
					</a>
